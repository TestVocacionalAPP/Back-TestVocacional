...
public class ExpertoMapper {
    ...
    public Experto toEntity(ExpertoCreateDTO expertoCreateDTO) {
        ...
        experto.setPassword(expertoCreateDTO.getPassword());  // Asegúrate de manejar el cifrado de la contraseña si es necesario
        ...
        experto.setCalificacion(0);  // Inicializa la calificación en 0
        return experto;
    }
